...
const FlashcardsTestingText = () => {
  return (
    <div>
      <h2 className={styles.prompt}>Instructions for Testing Phase:</h2>
      <ul>
        <li>In a grid format, you will type in the pairs of names.</li>
        <li>You will perform the grid 3 times in a row.</li>
        <li>Goal: 100% accuracy by the 3rd grid.</li>
        <li>If you’re not sure of a name, type your best guess. (Only click the IDK button if you cannot get it right).</li>
      </ul>
...
export default FlashcardsTesting;
